...
$toemails[] = array(
				'email' => 'info@georgiapeachtech.com', // Your Email Address
				'name' => 'GPTP' // Your Name
			);
...
$fromemail = array(
				'email' => 'info@georgiapeachtech.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'GPTP Lead' // Company Name
			);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Website Lead Submission';
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . '. All Rights Reserved.';

	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'Website Lead - ' . date('m-d-Y h:i:s');
